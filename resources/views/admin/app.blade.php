...
<div class="super_container">
    ...
    @guest
        <!-- Cart -->
            <div class="cart d-flex flex-row align-items-center justify-content-start">
                <div class="cart_icon"><a href="{{route("login")}}">
                        <img src="/bag.png" alt="">
    ...
    @else
        <!-- Cart -->
            <div class="cart d-flex flex-row align-items-center justify-content-start">
                <div class="cart_icon"><a href="{{route("userHistory",Auth::user()->id)}}">
                        <img src="/bag.png" alt="">

                        <div class="cart_num">
                            {{Auth::user()->carts->where("ordered","=",-1)->count()}}
                        </div>
                    </a></div>
                <div class="cart_text">bag</div>
                <div class="cart_price">$**.** ({{Auth::user()->carts->where("ordered","=",-1)->count()}})</div>
            </div>
        @endguest
        ...
        <div class="container-fluid">
            ...
            <div style="display: inline-block; float: left;margin: auto">
                <ul >
                    ...
                    <li class="ASD"><a href="{{route("statistics")}}">Statistics</a></li>
